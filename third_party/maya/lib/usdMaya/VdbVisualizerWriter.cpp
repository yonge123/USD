...
VdbVisualizerWriter::VdbVisualizerWriter(MDagPath& iDag, UsdStageRefPtr stage, const JobExportArgs& iArgs, usdWriteJob* jobPtr) :
    MayaTransformWriter(iDag, stage, iArgs, false, jobPtr), has_velocity_grids(false) {

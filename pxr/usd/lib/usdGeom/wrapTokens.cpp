...
void wrapUsdGeomTokens()
{
    ...
    _AddToken(cls, "best", UsdGeomTokens->best);
    ...
    _AddToken(cls, "coverage", UsdGeomTokens->coverage);
    _AddToken(cls, "coverageOrigin", UsdGeomTokens->coverageOrigin);
    ...
    _AddToken(cls, "fill", UsdGeomTokens->fill);
    _AddToken(cls, "fit", UsdGeomTokens->fit);
    ...
    _AddToken(cls, "horizontal", UsdGeomTokens->horizontal);
    ...
    _AddToken(cls, "offset", UsdGeomTokens->offset);
    ...
    _AddToken(cls, "rotate", UsdGeomTokens->rotate);
    ...
    _AddToken(cls, "vertical", UsdGeomTokens->vertical);

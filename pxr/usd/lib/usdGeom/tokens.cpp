...
UsdGeomTokensType::UsdGeomTokensType() :
    ...
    coverage("coverage", TfToken::Immortal),
    coverageOrigin("coverageOrigin", TfToken::Immortal),
    ...
    fill("fill", TfToken::Immortal),
    fit("fit", TfToken::Immortal),
    focalLength("focalLength", TfToken::Immortal),
    focusDistance("focusDistance", TfToken::Immortal),
    frame("frame", TfToken::Immortal),
    frameCache("frameCache", TfToken::Immortal),
    frameOffset("frameOffset", TfToken::Immortal),
    ...
    imageCenter("imageCenter", TfToken::Immortal),
    ...
    useFrameExtension("useFrameExtension", TfToken::Immortal),

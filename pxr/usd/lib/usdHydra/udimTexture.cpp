...
TF_REGISTRY_FUNCTION(TfType)
{
    TfType::Define<UsdHydraUdimTexture,
        TfType::Bases< UsdHydraUvTexture > >();
...
UsdAttribute
UsdHydraUdimTexture::GetUDimensionAttr() const
{
    return GetPrim().GetAttribute(UsdHydraTokens->uDimension);
}

UsdAttribute
UsdHydraUdimTexture::CreateUDimensionAttr(VtValue const &defaultValue, bool writeSparsely) const
{
    return UsdSchemaBase::_CreateAttr(UsdHydraTokens->uDimension,
...
UsdHydraUdimTexture::GetSchemaAttributeNames(bool includeInherited)
{
    static TfTokenVector localNames = {
        UsdHydraTokens->uDimension,
    };
    static TfTokenVector allNames =
        _ConcatenateAttributeNames(
            UsdHydraUvTexture::GetSchemaAttributeNames(true),
            localNames);

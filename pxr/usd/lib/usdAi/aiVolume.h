...
//
#ifndef USDAI_GENERATED_AIVOLUME_H
#define USDAI_GENERATED_AIVOLUME_H
...
public:
    ...
    /// Construct a UsdAiVolume on the prim held by \p schemaObj .
    ...
    /// Return a UsdAiVolume holding the prim adhering to this
